...
export default {
	props: {
		...
		//空数据图“加载失败”图片，默认使用next-paging内置的图片
		emptyViewErrorImg: {
			type: String,
		...
		//空数据图片是否铺满next-paging，默认为否，即填充满next-paging内列表(滚动区域)部分。若设置为否，则为填铺满整个next-paging
		emptyViewFixed: {
			type: Boolean,
