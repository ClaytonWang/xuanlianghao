...
<script>
	import zStatic from '../js/next-paging-static'
	import u from '../js/next-paging-utils'
	import Enum from '../js/next-paging-enum'
	
	export default {
		name: 'next-paging-refresh',
		data() {
			return {
				R: Enum.Refresher,
